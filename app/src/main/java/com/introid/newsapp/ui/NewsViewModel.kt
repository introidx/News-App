...
import com.introid.newsapp.NewsApplication
import com.introid.newsapp.models.Article
import com.introid.newsapp.models.NewsResponse
...
class NewsViewModel(
    ...
    // changes made
    val newsCat: MutableLiveData<String> = MutableLiveData()
    ...
    init {
        newsCat.postValue("all")
        getBreakingNews("in")
        searchNews(newsCat.value ?: "all")
    }
